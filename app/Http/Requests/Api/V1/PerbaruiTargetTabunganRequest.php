...
class PerbaruiTargetTabunganRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'jumlah_target' => ['sometimes', 'required', 'numeric', 'min:1000'],
            'rencana_harian' => ['nullable', 'numeric', 'min:0'],
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_target' => ['nullable', 'date', 'after_or_equal:tanggal_mulai'],
            'status' => ['sometimes', 'required', 'in:aktif,selesai,dijeda,dibatalkan'],
