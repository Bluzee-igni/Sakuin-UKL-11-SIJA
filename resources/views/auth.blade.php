...
<head>
    <script>
        // Terapkan tema dari localStorage sebelum render untuk menghindari FOUC
        const savedTheme = localStorage.getItem('sakuin_theme') || 'light';
    ...
    <div class="login-wrapper">
        <div class="login-card mx-auto" id="main-auth-content">
            ...
            <div class="login-left order-2 order-md-1">
                ...
                @if($errors->any())
                    <div class="alert bg-light-danger text-danger border border-danger border-opacity-25 rounded-4 py-2 small">
                        <ul class="mb-0 ps-3">
